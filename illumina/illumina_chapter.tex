...
The initial assembly quality was evaluated using QUAST~\cite{Gurevich2013} (version 2.3, see~\url{XX}) to align the \textit{de novo} assembly to a reference genome:
